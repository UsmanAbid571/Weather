...
const WeatherCard = async ({ weather }: props) => {
        ...
        <div >
            <div className="min-h-screen flex items-center justify-center">
                ...
                <div className="flex flex-col bg-white rounded-xl p-4 w-full max-w-xs">
                    <Searchbar />
                   <div className="font-bold text-3xl text-center mt-5 ">{weather.name}</div>
                    <div className="text-sm text-gray-500 text-center" >{new Date().toDateString()}</div>
